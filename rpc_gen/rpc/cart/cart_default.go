...
func SetItem(ctx context.Context, req *cart.SetItemReq, callOptions ...callopt.Option) (resp *cart.SetItemResp, err error) {
	resp, err = defaultClient.SetItem(ctx, req, callOptions...)
	if err != nil {
		klog.CtxErrorf(ctx, "SetItem call failed,err =%+v", err)
		return nil, err
	}
	return resp, nil
}
