...
type RPCClient interface {
	...
	SetItem(ctx context.Context, Req *cart.SetItemReq, callOptions ...callopt.Option) (r *cart.SetItemResp, err error)
...
func (c *clientImpl) SetItem(ctx context.Context, Req *cart.SetItemReq, callOptions ...callopt.Option) (r *cart.SetItemResp, err error) {
	return c.kitexClient.SetItem(ctx, Req, callOptions...)
}
