...
func (p *kCartServiceClient) SetItem(ctx context.Context, Req *cart.SetItemReq, callOptions ...callopt.Option) (r *cart.SetItemResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.SetItem(ctx, Req)
}
